...
import com.inihood.grandmusic.dialogs.ScanMediaFolderChooserDialog;
import com.inihood.grandmusic.glide.SongGlideRequest;
import com.inihood.grandmusic.helper.MusicPlayerRemote;
import com.inihood.grandmusic.helper.SearchQueryHelper;
...
import com.inihood.grandmusic.service.MusicService;
import com.inihood.grandmusic.ui.activities.base.AbsSlidingMusicPanelActivity;
import com.inihood.grandmusic.ui.activities.intro.AppIntroActivity;
import com.inihood.grandmusic.ui.fragments.mainactivity.folders.FoldersFragment;
import com.inihood.grandmusic.ui.fragments.mainactivity.library.LibraryFragment;
...
//        }
                ...
                switch (state) {
                    case 0:
                       // Toast.makeText(context, "Headset is unplugged", Toast.LENGTH_LONG).show();
                        ...
                        break;
                    case 1:
                        Toast.makeText(context, "Now playing via head phone", Toast.LENGTH_LONG).show();
    ...
    private void firstTimeOperation(Context context){
