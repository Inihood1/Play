package com.inihood.grandmusic.ui.fragments.player.card;
...
import com.inihood.grandmusic.adapter.song.PlayingQueueAdapter;
import com.inihood.grandmusic.dialogs.LyricsDialog;
import com.inihood.grandmusic.dialogs.SongShareDialog;
import com.inihood.grandmusic.helper.MusicPlayerRemote;
import com.inihood.grandmusic.helper.menu.SongMenuHelper;
import com.inihood.grandmusic.model.Song;
import com.inihood.grandmusic.model.lyrics.Lyrics;
import com.inihood.grandmusic.ui.activities.base.AbsSlidingMusicPanelActivity;
import com.inihood.grandmusic.ui.fragments.player.AbsPlayerFragment;
import com.inihood.grandmusic.ui.fragments.player.PlayerAlbumCoverFragment;
import com.inihood.grandmusic.util.ImageUtil;
import com.inihood.grandmusic.util.MusicUtil;
import com.inihood.grandmusic.util.Util;
import com.inihood.grandmusic.util.ViewUtil;
import com.inihood.grandmusic.views.WidthFitSquareLayout;
                ...
                if (lyrics == null) {
                    ...
                    if (toolbar != null && activity != null)
                        if (toolbar.getMenu().findItem(R.id.action_show_lyrics) == null) {
                            int color = ToolbarContentTintHelper.toolbarContentColor(activity, Color.TRANSPARENT);
                            Drawable drawable = ImageUtil.getTintedVectorDrawable(activity, R.drawable.ic_comment_text_white_24dp, color);
                            toolbar.getMenu()
