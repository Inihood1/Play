package com.inihood.grandmusic.service;
...
import com.inihood.grandmusic.appwidgets.AppWidgetBig;
import com.inihood.grandmusic.appwidgets.AppWidgetCard;
import com.inihood.grandmusic.appwidgets.AppWidgetClassic;
import com.inihood.grandmusic.appwidgets.AppWidgetSmall;
import com.inihood.grandmusic.glide.BlurTransformation;
import com.inihood.grandmusic.glide.SongGlideRequest;
import com.inihood.grandmusic.helper.ShuffleHelper;
import com.inihood.grandmusic.helper.StopWatch;
import com.inihood.grandmusic.loader.PlaylistSongLoader;
import com.inihood.grandmusic.model.AbsCustomPlaylist;
import com.inihood.grandmusic.model.Playlist;
import com.inihood.grandmusic.model.Song;
import com.inihood.grandmusic.provider.HistoryStore;
import com.inihood.grandmusic.provider.MusicPlaybackQueueStore;
import com.inihood.grandmusic.provider.SongPlayCountStore;
import com.inihood.grandmusic.service.notification.PlayingNotification;
import com.inihood.grandmusic.service.notification.PlayingNotificationImpl;
import com.inihood.grandmusic.service.notification.PlayingNotificationImpl24;
import com.inihood.grandmusic.service.playback.Playback;
import com.inihood.grandmusic.util.MusicUtil;
import com.inihood.grandmusic.util.PreferenceUtil;
import com.inihood.grandmusic.util.Util;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public static final String MUSIC_PACKAGE_NAME = "com.inihood.grandmusic";
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("com.inihood.grandmusic.MUSIC_SERVICE_CREATED"));
    }
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("com.inihood.grandmusic.MUSIC_SERVICE_DESTROYED"));
    }
